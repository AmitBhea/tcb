<?php 
 $GLOBALS["dictionary"]["Bhea_Payments"]=array (
  'table' => 'bhea_payments',
  'audited' => true,
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'bhea_payments_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'bhea_payments_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'bhea_payments_activities',
    ...
    array (
      'name' => 'team_link',
      'type' => 'link',
      'relationship' => 'bhea_payments_team',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'bhea_payments_team_count_relationship',
      'link_type' => 'one',
      'module' => 'Teams',
      'bean_name' => 'TeamSet',
      'source' => 'non-db',
    ...
    array (
      'name' => 'teams',
      'type' => 'link',
      'relationship' => 'bhea_payments_teams',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'bhea_payments_assigned_user',
    ...
    'bhea_memberships_bhea_payments_1_name' => 
    array (
    ...
    'bhea_memberships_bhea_payments_1bhea_memberships_ida' => 
    array (
    ...
    'bhea_council_memberships_bhea_payments_1_name' => 
    array (
    ...
    'bhea_invoices_bhea_payments_1bhea_invoices_ida' => 
    array (
  ...
  array (
    ...
    'team_set_bhea_payments' => 
    array (
      'name' => 'idx_bhea_payments_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'team_set_id',

<?php 
 $GLOBALS["dictionary"]["Bhea_Memberships"]=array (
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'bhea_memberships_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'bhea_memberships_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'bhea_memberships_activities',
    ...
    array (
      'name' => 'team_link',
      'type' => 'link',
      'relationship' => 'bhea_memberships_team',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'bhea_memberships_team_count_relationship',
      'link_type' => 'one',
      'module' => 'Teams',
      'bean_name' => 'TeamSet',
      'source' => 'non-db',
    ...
    array (
      'name' => 'teams',
      'type' => 'link',
      'relationship' => 'bhea_memberships_teams',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'bhea_memberships_assigned_user',
    ...
    array (
      ...
      'calculated' => 'true',
      'formula' => 'subtract($mem_fee,$discount_c)',
      'enforced' => 'true',
      'dependency' => '',
      'required' => false,
      ...
      'enable_range_search' => false,
      'precision' => 6,
      'id' => 'Bhea_Membershipsfinal_mem_fee_c',
      'custom_module' => 'Bhea_Memberships',
    ),
    ...
    'bhea_member_levels_bhea_memberships_1bhea_member_levels_ida' => 
    array (
    ...
    'accounts_bhea_memberships_1accounts_ida' => 
    array (
  ...
  array (
    ...
    'team_set_bhea_memberships' => 
    array (
      'name' => 'idx_bhea_memberships_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'team_set_id',
